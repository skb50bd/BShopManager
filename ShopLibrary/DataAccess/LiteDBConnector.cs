...
{
    public class LiteDBConnector : IDataConnection
    {
        ...
        public List<Transaction> GetTransactionsByDate(DateTime _from, DateTime _to)
        {
            throw new NotImplementedException();
        }

        public List<Transaction> GetTransactionsByBankAccount(BankAccount bankAccount, DateTime _from, DateTime _to)
        {
            throw new NotImplementedException();
        }
        ...
        public DebtCollection CollectDebt(DebtCollection due)
        {
            throw new NotImplementedException();
        }
        ...
        public List<DebtCollection> GetDebtCollectionByDate(DateTime _from, DateTime _to)
        {
            throw new NotImplementedException();
        }

        public bool DeleteDebtCollection(DebtCollection due)
        {
            throw new NotImplementedException();
        }

        public List<DebtCollection> GetDebtCollectionByCustomer(Customer customer, DateTime _from, DateTime _to)
        {
            throw new NotImplementedException();
        }
        ...
        public List<Repayment> GetRepaymentBySupplier(Supplier supplier, DateTime _from, DateTime _to)
        {
            throw new NotImplementedException();
        }

        public List<Repayment> GetRepaymentByDate(DateTime _from, DateTime _to)
        {
            throw new NotImplementedException();
        }
        ...
        public List<Payment> GetPaymentByEmployee(Employee employee, DateTime _from, DateTime _to)
        {
            throw new NotImplementedException();
        }

        public List<Payment> GetPaymentByDate(DateTime _from, DateTime _to)
        {
            throw new NotImplementedException();
        }
        ...
        public List<Sale> GetSaleByCustomer(Customer customer, DateTime _from, DateTime _to)
        {
            throw new NotImplementedException();
        }

        public List<Sale> GetSaleByDate(DateTime _from, DateTime _to)
        {
            throw new NotImplementedException();
        }

        public List<Sale> GetSaleByShop(Shop shop, DateTime _from, DateTime _to)
        {
            throw new NotImplementedException();
        }
        ...
        public List<Refund> GetRefundByDate(DateTime _from, DateTime _to)
        {
            throw new NotImplementedException();
        }
        ...
        public List<Refund> GetRefundByCustomer(Customer customer, DateTime _from, DateTime _to)
        {
            throw new NotImplementedException();
        }
        ...
        public List<Expense> GetExpenseByDate(DateTime _from, DateTime _to)
        {
            throw new NotImplementedException();
        }
        ...
        public List<Purchase> GetPurchaseByDate(DateTime _from, DateTime _to)
        {
            throw new NotImplementedException();
        }

        public List<Purchase> GetPurchaseBySupplier(Supplier supplier, DateTime _from, DateTime _to)
        {
            throw new NotImplementedException();
        }
        ...
        public List<PurchaseReturn> GetPurchaseReturnByDate(DateTime _from, DateTime _to)
        {
            throw new NotImplementedException();
        }
        ...
        public List<PurchaseReturn> GetPurchaseReturnBySupplier(Supplier supplier, DateTime _from, DateTime _to)
        {
            throw new NotImplementedException();
        }
        ...
        public List<CashModification> GetCashModificationAll()
        {
            throw new NotImplementedException();
        }
