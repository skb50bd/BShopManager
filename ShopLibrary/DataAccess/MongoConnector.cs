...
namespace ShopLibrary.DataAccess
{
    public class MongoConnector : IDataConnection
    {
        ...
        #region Collections
        private static IMongoCollection<BankAccount> BankAccountCollection => _db.GetCollection<BankAccount>("BankAccount");
        private static IMongoCollection<CashModification> CashModificationCollection => _db.GetCollection<CashModification>("CashModificaion");
        ...
        private IMongoCollection<DebtCollection> DebtCollection => _db.GetCollection<DebtCollection>("DebtCollection");
        ...
        private IMongoCollection<Purchase> SavedPurchaseCollection => _db.GetCollection<Purchase>("SavedPurchase");
        private IMongoCollection<PurchaseReturn> PurchaseReturnCollection => _db.GetCollection<PurchaseReturn>("PurchaseReturn");
        ...
        public ObjectId GetNextObjectId(string collectionName)
        {
            ...
            BsonDocument ret = col.FindOneAndUpdate(filter, update, new FindOneAndUpdateOptions<BsonDocument>
            {
                IsUpsert = true,
        ...
        public PurchaseReturn InsertPurchaseReturn(PurchaseReturn model)
        {
            ...
            try
            {
                ...
                {
                    BsonDocument filter = new BsonDocument("_id", cart.ProductId);
                    BsonDocument update = new BsonDocument("$inc", new BsonDocument("shopStock", (-1) * cart.BaseQuantity));
                    ProductCollection.UpdateOne(filter, update);
                }
