...
namespace WinFormsUI.Forms {
    public partial class BankAccountsForm : Form {
        ...
        private void WireUp() {
            ...
            AccountSelectorCombo.DataSource = BankAccounts.Select(ba => ba.AccountName + " - " + ba.CurrentBalance.ToString("N")).ToList();
        ...
        private void AccountSelectorCombo_SelectedIndexChanged(object sender, EventArgs e) => AccountSelectorCombo_SelectedIndexChanged();

        private void TransactionTypeSelectorCombo_SelectedIndexChanged(object sender, EventArgs e) => TransactionTypeSelectorCombo_SelectedIndexChanged();
        ...
        private void DeleteAccountButton_Click(object sender, EventArgs e) {
            ...
            if (confirm == DialogResult.Yes) {
                if (Connection[0]
                    .DeleteBankAccount(BankAccounts[AccountSelectorCombo.SelectedIndex])) {
