        ...
        private void FixColumns () {
            ...
            switch (report.ReportType) {
                ...
                #region Refund Columns
                    ...
                    col = new DataGridViewTextBoxColumn {
                                                            DataPropertyName =
                                                                nameof(ShopLibrary.Models.Refund.Created),
                                                            Name = "Time"
                                                        };
                    ReportsGrid.Columns.Add(col);
                    ...
                    col = new DataGridViewTextBoxColumn {
                                                            DataPropertyName =
                                                                nameof(ShopLibrary.Models.Refund.Creator),
                                                            Name = "Added by"
                                                        };
                    ReportsGrid.Columns.Add(col);
                #endregion
                ...
                #region Purchase Return Columns
                    ...
                    col = new DataGridViewTextBoxColumn {
                                                            DataPropertyName =
                                                                nameof(PurchaseReturn.GetPurchasReturnAmount),
                                                            Name = "Refunded"
                                                        };
                    ReportsGrid.Columns.Add(col);
                    ...
                    col = new DataGridViewTextBoxColumn {
                                                            DataPropertyName =
                                                                nameof(PurchaseReturn.GetPurchaseReturnCut),
                                                            Name = "Cut"
                                                        };
                    ReportsGrid.Columns.Add(col);
                ...
                #region Bank Account & Transactions
                    if (index2 <= 0) {
                        ...
                        if (index1 < 0) // All Bank Accounts
                            report.Transactions = (report as ITransactionReport)
                                                  .GetTransactions()
                                                  .Where(t => t.TransactionType == (TransactionType) index2)
                                                  .ToList();
                        else // Bank Account Selected
                            report.Transactions = (report as IBankAccountReport)
                                                  .GetBankTransactions(report.BankAccount)
        ...
        #region Make The Fields Visible
            ...
            switch (report.ReportType) {
                ...
                #region Summary
                    ...
                    StatPropText2.Text = report.CashFlows.Where(c => c.InFlow > 0).Sum(sc => sc.InFlow).ToString("0.##")
                                       + " Tk";
                    ...
                    StatPropText4.Text =
                        report.CashFlows.Where(c => c.OutFlow > 0).Sum(sc => sc.OutFlow).ToString("0.##") + " Tk";
                    ...
                    StatPropText6.Text = ((report as ITransactionReport).DepositTotal
                                        - (report as ITransactionReport).WithdrawTotal).ToString("0.##")
                                       + " Tk";
                ...
                #region Debt Collection
                    ...
                    StatPropText2.Text =
                        (report as IDebtCollectionReport).DebtCollectionTotal.ToString("0.##") + " Tk";
                ...
                #region Purchase Return
                    ...
                    StatPropText2.Text =
                        (report as IPurchaseReturnReport).PriceAmountTotal.ToString("0.##") + " Tk";
                    ...
                    StatPropText4.Text =
                        (report as IPurchaseReturnReport).RefundAmountTotal.ToString("0.##") + " Tk";
                    StatPropLabel5.Visible  = false;
                    StatPropText5.Visible   = false;
                    StatPropLabel6.Visible  = false;
                    StatPropText6.Visible   = false;
                ...
                #region Supplier
                    ...
                    StatPropText5.Text = (report as ISupplierReport).Repayments.Sum(r => r.Amount).ToString("0.##")
                                       + " Tk";
                    ...
                    StatPropText7.Text =
                        (report as ISupplierReport).PurchaseReturnPriceTotal.ToString("0.##") + " Tk";
                    StatPropLabel8.Visible  = false;
                    StatPropText8.Visible   = false;
                    StatPropLabel9.Visible  = false;
                    StatPropText9.Visible   = false;
                            ...
                            case DebtCollection _:
                                Connection[0]
                                    .DeleteDebtCollection(
                                                          report.DebtCollections.Single(dc => dc.DebtCollectionId
                                                                                           == customerReport.Id));
                            ...
                            case PurchaseReturn _:
                                Connection[0]
                                    .DeletePurchaseReturn(
                                                          report.PurchaseReturns.Single(pr => pr.PurchaseReturnId
                                                                                           == suppplierReport.Id));
